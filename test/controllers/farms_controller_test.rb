...
class FarmsControllerTest < ActionController::TestCase
  ...
  test "should create farm" do
    assert_difference('Farm.count') do
      post :create, farm: { address: @farm.address, description: @farm.description, name: @farm.name, phone: @farm.phone, user_id: @farm.user_id, website: @farm.website }
    end
  ...
  test "should update farm" do
    patch :update, id: @farm, farm: { address: @farm.address, description: @farm.description, name: @farm.name, phone: @farm.phone, user_id: @farm.user_id, website: @farm.website }
    assert_redirected_to farm_path(assigns(:farm))
  end
